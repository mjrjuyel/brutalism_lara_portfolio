...
export default function Register() {
  ...
  return (
    <GuestLayout>
      <Head title="System Access // Register Node" />
        ...
        >
          ...
          <div className="mb-6 border-b border-border/80 pb-4">
            <div className="flex items-center justify-between mb-2">
              <TechnicalLabel prefix="//">SEC_AUTH // 02</TechnicalLabel>
            ...
            <p className="font-mono text-xs text-muted-foreground mt-1">
              REGISTER CREDENTIALS TO REQUEST SYSTEM PRIVILEGES
            </p>
          </div>
          ...
          <form onSubmit={submit} className="space-y-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-background/90 border ${
                    ...
                    errors.name ? 'focus:ring-destructive' : 'focus:ring-primary'
                  } transition-colors`}
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="operator@portfolio.dev"
            ...
            <div className="pt-2 text-center border-t border-border/80">
              <span className="font-mono text-xs text-muted-foreground">EXISTING OPERATOR? </span>
              <Link 
                href={route('login')} 
